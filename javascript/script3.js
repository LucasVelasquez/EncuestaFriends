...
$(document).ready (function() {
    console.log (" Gunther ya esta listo para atenderlo, en que le puede servir?")
});

// //selecting all required elements
// const start_btn_Hard = document.querySelector(".start_btn button_Hard");
// const info_box_Hard = document.querySelector(".info_box_Hard");
// const exit_btn = info_box_Hard.querySelector(".buttons .quit_Hard");
// const continue_btn = info_box_Hard.querySelector(".buttons .restart_Hard");
// const quiz_box_Hard = document.querySelector(".quiz_box_Hard");
// const result_box_Hard = document.querySelector(".result_box_Hard");
// const option_list_Hard = document.querySelector(".option_list_Hard");
// const time_line = document.querySelector("header .time_line_Hard");
// const timeText = document.querySelector(".timer .time_left_txt");
// const timeCount= document.querySelector(".timer .timer_sec");

// // al darle a Versión Hardcore! que se genere
// start_btn_Hard.onclick = () => {
//     info_box_Hard.classList.add("activeInfo_Hard");
// };

// // al darle a Salir que se genere
// exit_btn_Hard.onclick = () => {
//     info_box_Hard.classList.remove("activeInfo_Hard"); // que esconda la info del box
// };

// // al darle a Continuar que se genere
// continue_btn_Hard.onclick = () => {
//     info_box_Hard.classList.remove("activeInfo_Hard"); // que esconda la info del box
//     quiz_box.classList.add("activeQuiz_Hard"); // Veo el quiz box
